...
namespace VLAB.ChemistryLab
{
    ...
    public sealed class DesktopLabNavigator : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            frame.PointerOverScrollableUi = desktopInterface != null && desktopInterface.IsPointerOverScrollableUi;
            ...
            if (frame.PrimaryPressed && !frame.CancelPressed && !frame.PointerOverScrollableUi && playerCamera != null && Mouse.current != null)
            {
            ...
            if (!wasHolding && (grabber == null || !grabber.IsHolding)) UpdateZoom(frame);
